                                ...
                                <div class="product_in_cat">
                                    ...
                                    <div class="boxgiamd">
                                        <p style="color:#595959;">
                                            ...
                                            Giá : <span style="color:#d50000;text-transform:uppercase; }">{{ number_format($girld->Giatien,0,',','.')}} VNĐ</span>
                                            @else
                                            Giá: <span style="color:#d50000;text-transform:uppercase;">{{ number_format($girld->Giakhuyenmai,0,',','.')}} VNĐ</span><br>
                                            Giá cũ: <span style="color:#ccc;text-transform:uppercase; text-decoration: line-through;}">{{ number_format($girld->Giatien,0,',','.')}} VNĐ</span>
                                            @endif
                                        </p>
                                    </div>

                                    <p class="addtocart">
                                        <a href="cart/addCart/{{$girld->id}}">Đặt hàng</a>
                                    </p>
